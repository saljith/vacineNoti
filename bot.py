    ...
    for i in range(0,3):
        ...
        try:
          ...
          if(len(count2)>0):
           ...
           nd_url=welcome="https://api.telegram.org/bot1811108401:AAH0Y4Ebv-092C4WIOJejP-tYIheyVjhIRY/sendmessage?chat_id=1061660183&text="+"Error"
           y=requests.get(nd_url,headers=headers)
